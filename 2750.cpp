...
int main() {
 ...
 cout << '|' << ' ' << "decimal" << setfill(' ') << setw(4) << '|' << setfill(' ') << setw(2) << ' ' << "octal" << ' ' << setfill(' ') << setw(2) << '|' << setfill(' ') << setw(2) << ' ' << "Hexadecimal" << setfill(' ') << setw(2) << ' ' << '|' <<  endl;
 cout << setfill('-') << setw(39) << '-' <<  endl;

 cout << '|' << setfill(' ') << setw(7) << "0" << setfill(' ') << setw(5) << '|' << setfill(' ') << setw(5) << "0" << setfill(' ') << setw(5) << '|' << setfill(' ') << setw(7) << ' ' << "0" << setfill(' ') << setw(8) << '|' <<  endl;
 cout << '|' << setfill(' ') << setw(7) << "1" << setfill(' ') << setw(5) << '|' << setfill(' ') << setw(5) << "1" << setfill(' ') << setw(5) << '|' << setfill(' ') << setw(7) << ' ' << "0" << setfill(' ') << setw(8) << '|' <<  endl;
 cout << '|' << setfill(' ') << setw(7) << "2" << setfill(' ') << setw(5) << '|' << setfill(' ') << setw(5) << "2" << setfill(' ') << setw(5) << '|' << setfill(' ') << setw(7) << ' ' << "0" << setfill(' ') << setw(8) << '|' <<  endl;
 cout << '|' << setfill(' ') << setw(7) << "3" << setfill(' ') << setw(5) << '|' << setfill(' ') << setw(5) << "3" << setfill(' ') << setw(5) << '|' << setfill(' ') << setw(7) << ' ' << "0" << setfill(' ') << setw(8) << '|' <<  endl;
 cout << '|' << setfill(' ') << setw(7) << "4" << setfill(' ') << setw(5) << '|' << setfill(' ') << setw(5) << "4" << setfill(' ') << setw(5) << '|' << setfill(' ') << setw(7) << ' ' << "0" << setfill(' ') << setw(8) << '|' <<  endl;
 cout << '|' << setfill(' ') << setw(7) << "5" << setfill(' ') << setw(5) << '|' << setfill(' ') << setw(5) << "5" << setfill(' ') << setw(5) << '|' << setfill(' ') << setw(7) << ' ' << "0" << setfill(' ') << setw(8) << '|' <<  endl;
 cout << '|' << setfill(' ') << setw(7) << "6" << setfill(' ') << setw(5) << '|' << setfill(' ') << setw(5) << "6" << setfill(' ') << setw(5) << '|' << setfill(' ') << setw(7) << ' ' << "0" << setfill(' ') << setw(8) << '|' <<  endl;
